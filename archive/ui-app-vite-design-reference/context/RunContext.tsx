...
export function RunProvider({ children }: { children: ReactNode }) {
	...
	// Story 7.5: History tracking - Initialize with demo data for MVP
	...
	const [metricsHistory, setMetricsHistory] = useState<{
		...
		eventsPerMinute: [1, 1, 10, 1, 2, 5, 3, 1, 8, 4],
		successRateTrend: [100, 100, 100, 100, 95, 100, 100, 100, 100, 100],
		latencyTrend: [245, 198, 312, 256, 287, 199, 234, 301, 278, 221],
		queueDepthTrend: [0, 1, 2, 1, 0, 3, 1, 0, 2, 1],
	});
